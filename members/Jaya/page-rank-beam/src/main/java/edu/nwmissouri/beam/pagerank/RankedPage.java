...
public class RankedPage {
    ...
    public static void main(String[] args) {
        ...
        PCollectionList<KV<String, String>> result = PCollectionList.of(PCollectionskvLinksKV1)
                .and(PCollectionskvLinksKV2).and(PCollectionskvLinksKV3).and(PCollectionskvLinksKV4);
    ...
    private static PCollection<KV<String, String>> jayaMapJob(Pipeline p, String dataFile, String Path) {
        ...
        PCollection<String> PCLinks = PCILLines.apply(
                MapElements.into(TypeDescriptors.strings())
                        .via((String linelink) -> linelink.substring(linelink.indexOf("(") + 1,
                                linelink.indexOf(")"))));
