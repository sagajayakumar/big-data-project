...
public class MinimalPageRankKothapally {
  ...
  public static void main(String[] args) {
    ...
    PCollection<KV<String, String>> pcol1 = KothapallyMapper(p, dataFolder, "go.md");
    PCollection<KV<String, String>> pcol2 = KothapallyMapper(p, dataFolder, "python.md");
    PCollection<KV<String, String>> pcol3 = KothapallyMapper(p, dataFolder, "java.md");
    PCollection<KV<String, String>> pcol4 = KothapallyMapper(p, dataFolder, "README.md");
    ...
    pLinksStr.apply(TextIO.write().to("kothapallyout"));

    p.run().waitUntilFinish();
  }

  private static PCollection<KV<String, String>> KothapallyMapper(Pipeline p, String dataFolder, String dataFile) {
